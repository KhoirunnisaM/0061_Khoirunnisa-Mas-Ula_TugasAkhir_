...
<div class="container mt-5">
    ...
    <form action="<?= site_url('Pegawai/laporan/cariStok'); ?>" method="POST" class="d-flex align-items-center">
        <?= csrf_field(); ?>
        ...
        <div class="col-md-3">
            <label>&nbsp;</label>
            <a href="<?= site_url('Pegawai/laporan/cetakStok?bulan=' . ($bulan ?? '') . '&tahun=' . ($tahun ?? '')); ?>"
